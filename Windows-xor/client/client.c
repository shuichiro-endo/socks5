...
void usage(char *filename)
{
	...
	printf("             : %s -h 192.168.0.5 -p 9050 -H 192.168.0.10 -P 9050 -x -A 3 -B 0 -C 3 -D 0\n", filename);
	printf("             : %s -h fe80::xxxx:xxxx:xxxx:xxxx%%14 -p 9050 -H fe80::yyyy:yyyy:yyyy:yyyy%%14 -P 9050 -x -A 3 -B 0 -C 3 -D 0\n", filename);
	printf("or\n");
	...
	printf("             : %s -r -h localhost -p 9050 -H 192.168.0.5 -P 1234 -x -k deadbeef\n", filename);
	printf("             : %s -r -h ::1 -p 9050 -H 192.168.0.5 -P 1234 -x -A 3 -B 0 -C 3 -D 0\n", filename);
	printf("             : %s -r -h 192.168.0.5 -p 9050 -H 192.168.0.5 -P 1234 -x -A 3 -B 0 -C 3 -D 0\n", filename);
	printf("             : %s -r -h fe80::xxxx:xxxx:xxxx:xxxx%%14 -p 9050 -H fe80::xxxx:xxxx:xxxx:xxxx%%14 -P 1234 -x -A 3 -B 0 -C 3 -D 0\n", filename);
}
